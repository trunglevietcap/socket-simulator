...
export const marketStatusHNXRef = ref(
  db,
  `${FIREBASE_DB_NAME.MARKET_STATUS}/HNX`
);
export const marketStatusHOSERef = ref(
  db,
  `${FIREBASE_DB_NAME.MARKET_STATUS}/HOSE`
);
export const marketStatusUPCOMRef = ref(
  db,
  `${FIREBASE_DB_NAME.MARKET_STATUS}/UPCOM`
);
export const marketStatusDERIVATIVESRef = ref(
  db,
  `${FIREBASE_DB_NAME.MARKET_STATUS}/DERIVATIVES`
);
export const marketTopStockChangeRef = ref(
  db,
  FIREBASE_DB_NAME.MARKET_DATA_TOP_STOCK_CHANGE
);
...
export const orderBookDerivativeRef = ref(
  db,
  FIREBASE_DB_NAME.DERIVATIVE_ORDER_BOOK
);
